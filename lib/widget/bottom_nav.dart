  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FlashyTabBar(
        ...
        items: [
          FlashyTabBarItem(icon: Icon(Icons.apps), title: Text('Aktivitas')),
          FlashyTabBarItem(icon: Icon(Icons.home), title: Text('Beranda')),
          FlashyTabBarItem(icon: Icon(Icons.person), title: Text('Akun')),
        ],
      ),
    );
  }
